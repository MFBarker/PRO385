Welcome to the alpha of Frog Izakaya!
...
![image](https://github.com/user-attachments/assets/05e1fdc6-42ed-43ac-b8bc-b03f22576d29)
![image](https://github.com/user-attachments/assets/3577a652-8ea2-4934-ae58-68b175e967d0)
![image](https://github.com/user-attachments/assets/15deb17b-9f7d-4ae2-a30b-0b030c6a7d06)
![image](https://github.com/user-attachments/assets/607f74cf-138e-4dba-b7dd-b56782f67dfa)

Technical Details:
This game was made with Unity and Visual Studio, with FireAlpaca being used to create some of the assets.
While I am rather familiar with Unity, mobile games are still pretty unfamiliar to me. Luckily, it was pretty similar to the way you normally develop in Unity (but just focused on working on a phone).
...
What's Next?
* Get it ported to either mobile or WebGL (which will be posted onto my Itch: https://dumb-insomniac.itch.io)
* Make Improvements on the Game (Assets, AI, Game Loop, More Customers, etc.)
* Save/Load Game
* And More! (eventually)
